#!/usr/bin/env python3
"""Generate the WorkflowPatch sales AI handoff proof outputs."""
...
def main() -> None:
    ...
    ledger_rows = read_rows("sales-handoff-ledger.csv")
    review_rows = read_rows("lead-response-review-queue.csv")
